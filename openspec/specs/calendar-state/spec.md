# calendar-state Specification

## Purpose
Manages calendar UI state using Zustand, including data fetching with TanStack Query, optimistic UI updates, and URL state persistence for the calendar feature.
